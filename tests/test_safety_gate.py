...
class TestSafetyGate:
    ...
    def test_initialization(self):
        ...
        gate = SafetyGate(confidence_threshold=0.75, drift_threshold=0.25, allow_warning=True)
    ...
    def test_should_deploy_warning_allowed(
        self, sample_predictions, sample_reference_data, sample_current_data
    ):
