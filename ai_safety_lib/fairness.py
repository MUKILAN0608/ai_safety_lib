...
class FairnessAnalyzer:
    ...
    def calculate_demographic_parity(
        ...
        for group in unique_groups:
            group_preds = [
                binary_preds[i] 
                for i, g in enumerate(protected_groups) 
                if g == group
            ]
            if group_preds:
    ...
    def comprehensive_fairness_check(
        ...
        if true_labels is not None:
            reports.append(self.calculate_equal_opportunity(
        ...
        if privileged_group is not None:
            reports.append(self.calculate_disparate_impact(
                predictions, protected_groups, privileged_group
            ))
